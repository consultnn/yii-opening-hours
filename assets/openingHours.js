        ...
        loadDataFromHiddenInputs: function() {
            ...
            for(var day in tempData) {
                ...
                if(range2_from[0] == 0 && range2_to[0] == 0) {
                    controlData.time = Array.join(Array.concat(range1_from, range1_to, range2_from, range2_to), '-');
                } else {
                    controlData.time = Array.join(Array.concat(range1_from, range2_to, range1_to, range2_from), '-');
